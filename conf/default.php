...
$conf['fmtstr_booklet'] = '';
$conf['fmtstr_conference'] = '{@AUTHOR@}{ (@YEAR@)}{: "@TITLE@"}{, in: <em>@BOOKTITLE@</em>}{, @EDITOR@ (@editorabbrev@)}{, @pagesabbrev@ @PAGES@}{. @PUBLISHER@}{, @ADDRESS@}.{ @NOTE@}{ <a href="https://doi.org/@DOI@">(DOI)</a>}{ <a href="@URL@">(Link)</a>}';
$conf['fmtstr_inbook'] = '{@AUTHOR@}{ (@YEAR@)}{: "@TITLE@"}{, in: <em>@BOOKTITLE@</em>}{, @EDITOR@ (@editorabbrev@)}{, @chapterabbrev@ @CHAPTER@}{, @pagesabbrev@ @PAGES@}{. @PUBLISHER@}{, @ADDRESS@}.{ @NOTE@}{ <a href="https://doi.org/@DOI@">(DOI)</a>}{ <a href="@URL@">(Link)</a>}';
$conf['fmtstr_incollection'] = '{@AUTHOR@}{ (@YEAR@)}{: "@TITLE@"}{, in: <em>@BOOKTITLE@</em>}{, @EDITOR@ (@editorabbrev@)}{, @chapterabbrev@ @CHAPTER@}{, @pagesabbrev@ @PAGES@}{. @PUBLISHER@}{, @ADDRESS@}.{ @NOTE@}{ <a href="https://doi.org/@DOI@">(DOI)</a>}{ <a href="@URL@">(Link)</a>}';
$conf['fmtstr_inproceedings'] = '{@AUTHOR@}{ (@YEAR@)}{: "@TITLE@"}{, in: <em>@BOOKTITLE@</em>}{, @EDITOR@ (@editorabbrev@)}{, @pagesabbrev@ @PAGES@}{. @PUBLISHER@}{, @ADDRESS@}.{ @NOTE@}{ <a href="https://doi.org/@DOI@">(DOI)</a>}{ <a href="@URL@">(Link)</a>}';
$conf['fmtstr_manual'] = '';
